...
class LayoutController
{
    ...
    public function index(Application $app, Request $request, $id = 1, $origId = 1)
    {
        ...
        if ('POST' === $request->getMethod()) {
            ...
            if ($form->isValid()) {
                ...
                if ($this->isPreview) {
                    ...
                    // fix 表示先をプラグインのページに変更
                    return $app->redirect($app->url('plugin_admin_content_layout_edit', array('id' => $id)));
                }
        ...
        // fix 表示先をプラグインのページに変更
        return $app->render('DSContents/Resource/template/admin/Content/layout.twig', array(
